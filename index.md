...
------------
#### While working on this artifact i have learned to how to better manage memory that is being used by applicaiton. I have also learned to prevent potential critical errors that arise from ignoring how memory is being used and how much of it is being allocated. Overall i was able to be more efficient with how much memory needs to be used for a tasks that needs to be completed.
------------
...
------------
#### While working on this artifact i was able to better organize various configuraiton data inside custom class. By doing so it made my code clean and easy to understand. It also helped during debuggin stages since i had to make changes only in one area. It also allowed me to handle various data types and connect UI elements to it with ease.
------------
